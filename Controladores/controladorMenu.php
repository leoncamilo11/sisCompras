      ...
      if (isset($_SESSION["sesionIniciada"])) {
        if ($_SESSION["rol"] == 3) {
          echo '<li><a href="usuarios" class="dropdown-button btn" data-activates="listaUsuarios">Usuarios<i class="material-icons right">supervisor_account</i></a></li>';
					...
					echo '<li>'. $_SESSION["nombre"] ." ". $_SESSION["apellido"]. " ". "FAOCO".'</li>';
					echo '<li><a href="introduccion" class="dropdown-button" data-activates="listaSalida"><i class="material-icons left">arrow_drop_down</i></a></li>';
        } else {
